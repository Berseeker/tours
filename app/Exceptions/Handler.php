    ...
    public function render($request, Throwable $exception)
    {
        if( $request->is('api/*')){
            ...
            if($exception instanceof ModelNotFoundException){
                ...
                return response()->json(['message' => 'No existe ninguna instancia de '.$modelo.' con el id solicitado', 'code' => 404, 'data' => null, 'status' => 'Error']);
            }
            ...
            if($exception instanceof QueryException){
                ...
                switch ($codigo) {
                    ...
                    case 1062:
                        ...
                        break;
                    default:
                        return response()->json(['message' => 'Falla inesperada  '.$exception, 'code' => 409, 'data' => null, 'status' => 'Error']);
                        break;
                }
            }
            return response()->json(['message' => 'Falla inesperada. Intente Luego '.$exception, 'code' => 500, 'data' => null, 'status' => 'Error']);
        }
