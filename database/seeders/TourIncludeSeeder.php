...
class TourIncludeSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('tours_includes')->insert([
            ...
            'item_en' => '<strong>Meal:</strong> Breakfast included'
        ]);

        DB::table('tours_includes')->insert([
            'included' => false,
            'item_es' => '<strong>Transportacion:</strong> Incluida desde tu hospedaje hasta el tour',
            'item_en' => '<strong>Transportation:</strong> Included where you are host till the tour'
        ]);

        DB::table('tours_includes')->insert([
            'included' => true,
            'item_es' => '<strong>Guia:</strong> Incluido en el tour',
            'item_en' => '<strong>Guide:</strong> Included in the tour'
        ]);
    }
}
